...
import com.example.mvvm.adapters.ShopListAdapter;
import com.example.mvvm.databinding.FragmentShopBinding;
...
public class shopFragment extends Fragment implements ShopListAdapter.ShopInterface {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        shopViewModels.getProducts().observe(getViewLifecycleOwner(), new Observer<List<Product>>() {
            @Override
    ...
    public void addItem(Product product) {
      boolean isAdded = shopViewModels.addItemToCart(product);
       if (isAdded){
           Snackbar.make(requireView(),product.getName() + " add to cart.", BaseTransientBottomBar.LENGTH_LONG)
           ...
           Snackbar.make(requireView(),"Already have the max quantity in cart.", BaseTransientBottomBar.LENGTH_LONG).show();
       }
    }

    @Override
    public void onItemClick(Product product) {
        shopViewModels.setProduct(product);
